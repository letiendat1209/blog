...
const Tags = ["React", "Next.js", "Node.js", "Tailwind CSS", "Git", "GitHub", "Open Source", "Development", "UI/UX", "NTTU University", "Web", "JavaScript", "HTML&CSS"];
      ...
      <main className="relative z-10 flex-1">
        <div className="container mx-auto px-4 py-12 md:py-20 max-w-7xl">
          ...
          <div className="flex flex-wrap justify-center gap-2 mb-16 max-w-3xl mx-auto">
            {Tags.map((tag) => (
              <Button key={tag} variant="outline" className="rounded-3xl">
                {tag}
              </Button>
            ))}
          </div>
